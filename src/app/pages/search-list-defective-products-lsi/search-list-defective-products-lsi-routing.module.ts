...
const routes: Routes = [
  ...
  {
    path: '',
    redirectTo: 'search-list-defective-products-lsi'
  },
  {
    path: 'search-list-defective-products-lsi',
    component: SearchListDefectiveProductsLsiComponent
  },
];
...
export class SearchListDefectiveProductsLsiRoutingModule { }
