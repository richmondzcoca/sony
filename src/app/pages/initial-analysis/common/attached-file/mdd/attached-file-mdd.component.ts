...
@Component({
  selector: 'app-attached-file-mdd',
    templateUrl: './attached-file-mdd.component.html',
    styleUrls: ['./attached-file-mdd.component.less'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AttachedFileMddComponent implements OnInit {
