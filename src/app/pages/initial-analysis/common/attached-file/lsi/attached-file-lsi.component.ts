...
@Component({
  selector: 'app-attached-file-lsi',
    templateUrl: './attached-file-lsi.component.html',
    styleUrls: ['./attached-file-lsi.component.less'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AttachedFileLsiComponent implements OnInit {
    ...
    attachedFileData: wjcCore.CollectionView | [];
