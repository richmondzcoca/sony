...
@Component({
  selector: 'app-search-list-defective-products-is',
  templateUrl: './search-list-defective-products-is.component.html',
  styleUrls: ['./search-list-defective-products-is.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SearchListDefectiveProductsIsComponent implements OnInit {
